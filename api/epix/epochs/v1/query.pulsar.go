...
func init() {
	file_epix_epochs_v1_query_proto_init()
	md_QueryEpochsInfoRequest = File_epix_epochs_v1_query_proto.Messages().ByName("QueryEpochsInfoRequest")
...
func (x *QueryEpochsInfoRequest) slowProtoReflect() protoreflect.Message {
	mi := &file_epix_epochs_v1_query_proto_msgTypes[0]
...
func (x *fastReflection_QueryEpochsInfoRequest) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "epix.epochs.v1.QueryEpochsInfoRequest.pagination":
		return x.Pagination != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: epix.epochs.v1.QueryEpochsInfoRequest"))
		}
		panic(fmt.Errorf("message epix.epochs.v1.QueryEpochsInfoRequest does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_QueryEpochsInfoRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message epix.epochs.v1.QueryEpochsInfoRequest does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_QueryEpochsInfoRequest) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in epix.epochs.v1.QueryEpochsInfoRequest", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_epix_epochs_v1_query_proto_init()
	md_QueryEpochsInfoResponse = File_epix_epochs_v1_query_proto.Messages().ByName("QueryEpochsInfoResponse")
...
func (x *QueryEpochsInfoResponse) slowProtoReflect() protoreflect.Message {
	mi := &file_epix_epochs_v1_query_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_QueryEpochsInfoResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "epix.epochs.v1.QueryEpochsInfoResponse.epochs":
		return len(x.Epochs) != 0
	case "epix.epochs.v1.QueryEpochsInfoResponse.pagination":
		return x.Pagination != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: epix.epochs.v1.QueryEpochsInfoResponse"))
		}
		panic(fmt.Errorf("message epix.epochs.v1.QueryEpochsInfoResponse does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_QueryEpochsInfoResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message epix.epochs.v1.QueryEpochsInfoResponse does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_QueryEpochsInfoResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in epix.epochs.v1.QueryEpochsInfoResponse", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_epix_epochs_v1_query_proto_init()
	md_QueryCurrentEpochRequest = File_epix_epochs_v1_query_proto.Messages().ByName("QueryCurrentEpochRequest")
...
func (x *QueryCurrentEpochRequest) slowProtoReflect() protoreflect.Message {
	mi := &file_epix_epochs_v1_query_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_QueryCurrentEpochRequest) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "epix.epochs.v1.QueryCurrentEpochRequest.identifier":
		return x.Identifier != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: epix.epochs.v1.QueryCurrentEpochRequest"))
		}
		panic(fmt.Errorf("message epix.epochs.v1.QueryCurrentEpochRequest does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_QueryCurrentEpochRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message epix.epochs.v1.QueryCurrentEpochRequest does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_QueryCurrentEpochRequest) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "epix.epochs.v1.QueryCurrentEpochRequest.identifier":
		panic(fmt.Errorf("field identifier of message epix.epochs.v1.QueryCurrentEpochRequest is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: epix.epochs.v1.QueryCurrentEpochRequest"))
		}
...
func (x *fastReflection_QueryCurrentEpochRequest) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in epix.epochs.v1.QueryCurrentEpochRequest", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_epix_epochs_v1_query_proto_init()
	md_QueryCurrentEpochResponse = File_epix_epochs_v1_query_proto.Messages().ByName("QueryCurrentEpochResponse")
...
func (x *QueryCurrentEpochResponse) slowProtoReflect() protoreflect.Message {
	mi := &file_epix_epochs_v1_query_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_QueryCurrentEpochResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "epix.epochs.v1.QueryCurrentEpochResponse.current_epoch":
		return x.CurrentEpoch != int64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: epix.epochs.v1.QueryCurrentEpochResponse"))
		}
		panic(fmt.Errorf("message epix.epochs.v1.QueryCurrentEpochResponse does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_QueryCurrentEpochResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message epix.epochs.v1.QueryCurrentEpochResponse does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_QueryCurrentEpochResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "epix.epochs.v1.QueryCurrentEpochResponse.current_epoch":
		panic(fmt.Errorf("field current_epoch of message epix.epochs.v1.QueryCurrentEpochResponse is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: epix.epochs.v1.QueryCurrentEpochResponse"))
		}
...
func (x *fastReflection_QueryCurrentEpochResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in epix.epochs.v1.QueryCurrentEpochResponse", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: epix/epochs/v1/query.proto
...
func (*QueryEpochsInfoRequest) Descriptor() ([]byte, []int) {
	return file_epix_epochs_v1_query_proto_rawDescGZIP(), []int{0}
}
...
func (*QueryEpochsInfoResponse) Descriptor() ([]byte, []int) {
	return file_epix_epochs_v1_query_proto_rawDescGZIP(), []int{1}
}
...
func (*QueryCurrentEpochRequest) Descriptor() ([]byte, []int) {
	return file_epix_epochs_v1_query_proto_rawDescGZIP(), []int{2}
}
...
func (*QueryCurrentEpochResponse) Descriptor() ([]byte, []int) {
	return file_epix_epochs_v1_query_proto_rawDescGZIP(), []int{3}
}
...
var File_epix_epochs_v1_query_proto protoreflect.FileDescriptor

var file_epix_epochs_v1_query_proto_rawDesc = []byte{
	0x0a, 0x1a, 0x65, 0x70, 0x69, 0x78, 0x2f, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x73, 0x2f, 0x76, 0x31,
	0x2f, 0x71, 0x75, 0x65, 0x72, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0e, 0x65, 0x70,
	0x69, 0x78, 0x2e, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x73, 0x2e, 0x76, 0x31, 0x1a, 0x14, 0x67, 0x6f,
	...
	0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x1c, 0x65, 0x70,
	0x69, 0x78, 0x2f, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x73, 0x2f, 0x76, 0x31, 0x2f, 0x67, 0x65, 0x6e,
	0x65, 0x73, 0x69, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x60, 0x0a, 0x16, 0x51, 0x75,
	...
	0x68, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x65, 0x70, 0x69, 0x78, 0x2e,
	...
	,
}

var (
	file_epix_epochs_v1_query_proto_rawDescOnce sync.Once
	file_epix_epochs_v1_query_proto_rawDescData = file_epix_epochs_v1_query_proto_rawDesc
)

func file_epix_epochs_v1_query_proto_rawDescGZIP() []byte {
	file_epix_epochs_v1_query_proto_rawDescOnce.Do(func() {
		file_epix_epochs_v1_query_proto_rawDescData = protoimpl.X.CompressGZIP(file_epix_epochs_v1_query_proto_rawDescData)
	})
	return file_epix_epochs_v1_query_proto_rawDescData
}

var file_epix_epochs_v1_query_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_epix_epochs_v1_query_proto_goTypes = []interface{}{
	(*QueryEpochsInfoRequest)(nil),    // 0: epix.epochs.v1.QueryEpochsInfoRequest
	(*QueryEpochsInfoResponse)(nil),   // 1: epix.epochs.v1.QueryEpochsInfoResponse
	(*QueryCurrentEpochRequest)(nil),  // 2: epix.epochs.v1.QueryCurrentEpochRequest
	(*QueryCurrentEpochResponse)(nil), // 3: epix.epochs.v1.QueryCurrentEpochResponse
	(*v1beta1.PageRequest)(nil),       // 4: cosmos.base.query.v1beta1.PageRequest
	(*EpochInfo)(nil),                 // 5: epix.epochs.v1.EpochInfo
	(*v1beta1.PageResponse)(nil),      // 6: cosmos.base.query.v1beta1.PageResponse
}
var file_epix_epochs_v1_query_proto_depIdxs = []int32{
	4, // 0: epix.epochs.v1.QueryEpochsInfoRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	5, // 1: epix.epochs.v1.QueryEpochsInfoResponse.epochs:type_name -> epix.epochs.v1.EpochInfo
	6, // 2: epix.epochs.v1.QueryEpochsInfoResponse.pagination:type_name -> cosmos.base.query.v1beta1.PageResponse
	0, // 3: epix.epochs.v1.Query.EpochInfos:input_type -> epix.epochs.v1.QueryEpochsInfoRequest
	2, // 4: epix.epochs.v1.Query.CurrentEpoch:input_type -> epix.epochs.v1.QueryCurrentEpochRequest
	1, // 5: epix.epochs.v1.Query.EpochInfos:output_type -> epix.epochs.v1.QueryEpochsInfoResponse
	3, // 6: epix.epochs.v1.Query.CurrentEpoch:output_type -> epix.epochs.v1.QueryCurrentEpochResponse
...
func init() { file_epix_epochs_v1_query_proto_init() }
func file_epix_epochs_v1_query_proto_init() {
	if File_epix_epochs_v1_query_proto != nil {
		return
	}
	file_epix_epochs_v1_genesis_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_epix_epochs_v1_query_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_epix_epochs_v1_query_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_epix_epochs_v1_query_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_epix_epochs_v1_query_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_epix_epochs_v1_query_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_epix_epochs_v1_query_proto_goTypes,
		DependencyIndexes: file_epix_epochs_v1_query_proto_depIdxs,
		MessageInfos:      file_epix_epochs_v1_query_proto_msgTypes,
	}.Build()
	File_epix_epochs_v1_query_proto = out.File
	file_epix_epochs_v1_query_proto_rawDesc = nil
	file_epix_epochs_v1_query_proto_goTypes = nil
	file_epix_epochs_v1_query_proto_depIdxs = nil
}
