...
const (
	Query_Params_FullMethodName         = "/epix.coinswap.v1.Query/Params"
	Query_LiquidityPool_FullMethodName  = "/epix.coinswap.v1.Query/LiquidityPool"
	Query_LiquidityPools_FullMethodName = "/epix.coinswap.v1.Query/LiquidityPools"
)
