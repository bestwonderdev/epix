...
// IsTestnet returns true if the chain-id has the epix testnet EIP155 chain prefix.
...
// GetepixAddressFromBech32 returns the sdk.Account address of given address,
// while also changing bech32 human readable prefix (HRP) to the value set on
// the global sdk.Config (eg: `epix`).
// The function fails if the provided bech32 address is invalid.
func GetepixAddressFromBech32(address string) (sdk.AccAddress, error) {
