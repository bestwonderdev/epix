...
rem Set moniker and chain-id for epix (Moniker can be anything, chain-id must be an integer)
...
epixd add-genesis-account %KEY% 100000000000000000000000000aepix --keyring-backend %KEYRING%

rem Sign genesis transaction
epixd gentx %KEY% 1000000000000000000000aepix --keyring-backend %KEYRING% --chain-id %CHAINID%
...
epixd start --pruning=nothing %TRACE% --log_level %LOGLEVEL% --minimum-gas-prices=0.0001aepix --chain-id %CHAINID%