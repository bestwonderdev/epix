...
func setupWithGenesisAccounts() *app.Epix {
...
func (suite *TestSuite) TestAmountOf() {
	...
	MaxSwapAmount := sdk.NewCoins(
		sdk.NewInt64Coin("ibc/8C2E3CD84DB23CCFB34A14E4EA933B6C38F9EA3FD7187E405C889C66C4347D31", 1000000),
		sdk.NewInt64Coin("ibc/1A9E6C67B20E24F2F2E551D1E1B6E27F0D171B92B4215F0338F0F0D931A98264", 1000000),
	)

	searchDenom := "ibc/8C2E3CD84DB23CCFB34A14E4EA933B6C38F9EA3FD7187E405C889C66C4347D31"
