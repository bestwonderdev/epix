...
func (suite *TestSuite) TestMsgSwapOrder_ValidateBasic() {
	...
	suite.Require().Equal("/epix.coinswap.v1.MsgSwapOrder", sdk.MsgTypeURL(&msg))
...
func (suite *TestSuite) TestMsgAddLiquidity_ValidateBasic() {
	msg := types.MsgAddLiquidity{}
	suite.Require().Equal("/epix.coinswap.v1.MsgAddLiquidity", sdk.MsgTypeURL(&msg))
...
func (suite *TestSuite) TestMsgRemoveLiquidity_ValidateBasic() {
	...
	suite.Require().Equal("/epix.coinswap.v1.MsgRemoveLiquidity", sdk.MsgTypeURL(&msg))
