...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"epix", "coinswap", "params"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_LiquidityPool_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"epix", "coinswap", "pools", "lpt_denom"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_LiquidityPools_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"epix", "coinswap", "pools"}, "", runtime.AssumeColonVerbOpt(false)))
)
