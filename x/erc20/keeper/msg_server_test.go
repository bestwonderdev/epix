...
func (suite *KeeperTestSuite) TestMsgConvertCoin_ValidateBasic() {
	...
	suite.Require().Equal("/epix.erc20.v1.MsgConvertCoin", sdk.MsgTypeURL(&msg))
...
func (suite *KeeperTestSuite) TestMsgConvertERC20_ValidateBasic() {
	...
	suite.Require().Equal("/epix.erc20.v1.MsgConvertERC20", sdk.MsgTypeURL(&msg))
	...
	testCases := []struct {
	...
	}{
		{
			...
			&types.MsgRegisterCoin{
				Authority:   "epix1yrmjye0zyfvr0lthc6fwq7qlwg9e8muftxa630",
