...
// It swaps the transferred IBC denom to aepix and
// convert the remaining balance to ERC20 tokens.
// If the balance of aepix is greater than the predefined value,
...
func (k Keeper) OnRecvPacket(
	...
	// and the asset transferred to the Epix network will still remain in the Epix network
	...
	// Get recipient addresses in `epix1` and the original bech32 format
