...
var (
	_ runtime.AppI            = (*Epix)(nil)
	_ servertypes.Application = (*Epix)(nil)
	_ ibctesting.TestingApp   = (*Epix)(nil)
)

// Epix implements an extended ABCI application. It is an application
...
func init() {
	...
	// manually update the power reduction by replacing micro (u) -> atto (a) Epix
...
// NewEpix returns a reference to a new initialized Ethermint application.
func NewEpix(
	logger log.Logger,
	db dbm.DB,
...
// use Epix's custom AnteHandler
func (app *Epix) setAnteHandler(txConfig client.TxConfig, maxGasWanted uint64, cdc codec.BinaryCodec, simulation bool) {
...
func (app *Epix) Name() string { return app.BaseApp.Name() }

// PreBlocker updates every pre begin block
func (app *Epix) PreBlocker(ctx sdk.Context, _ *abci.RequestFinalizeBlock) (*sdk.ResponsePreBlock, error) {
...
func (app *Epix) BeginBlocker(ctx sdk.Context) (sdk.BeginBlock, error) {
	return app.ModuleManager.BeginBlock(ctx)
}

// EndBlocker updates every end block
func (app *Epix) EndBlocker(ctx sdk.Context) (sdk.EndBlock, error) {
	return app.ModuleManager.EndBlock(ctx)
}

func (app *Epix) Configurator() module.Configurator {
	return app.configurator
}

// InitChainer updates at chain initialization
func (app *Epix) InitChainer(ctx sdk.Context, req *abci.RequestInitChain) (*abci.ResponseInitChain, error) {
...
func (app *Epix) LoadHeight(height int64) error {
	return app.LoadVersion(height)
}

// ModuleAccountAddrs returns all the app's module account addresses.
func (app *Epix) ModuleAccountAddrs() map[string]bool {
...
// LegacyAmino returns Epix's amino codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *Epix) LegacyAmino() *codec.LegacyAmino {
	return app.legacyAmino
}

// AppCodec returns Epix's app codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *Epix) AppCodec() codec.Codec {
	return app.appCodec
}

// InterfaceRegistry returns Epix's InterfaceRegistry
func (app *Epix) InterfaceRegistry() types.InterfaceRegistry {
	return app.interfaceRegistry
}

// TxConfig returns Epix's TxConfig
func (app *Epix) TxConfig() client.TxConfig {
	return app.txConfig
}

// AutoCliOpts returns the autocli options for the app.
func (app *Epix) AutoCliOpts() autocli.AppOptions {
...
func (app *Epix) DefaultGenesis() map[string]json.RawMessage {
...
func (app *Epix) GetKey(storeKey string) *storetypes.KVStoreKey {
	return app.keys[storeKey]
}

// GetStoreKeys returns all the stored store keys.
func (app *Epix) GetStoreKeys() []storetypes.StoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *Epix) GetTKey(storeKey string) *storetypes.TransientStoreKey {
...
func (app *Epix) GetMemKey(storeKey string) *storetypes.MemoryStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *Epix) GetSubspace(moduleName string) paramstypes.Subspace {
	subspace, _ := app.ParamsKeeper.GetSubspace(moduleName)
	return subspace
}

// SimulationManager implements the SimulationApp interface
func (app *Epix) SimulationManager() *module.SimulationManager {
	return app.sm
}

// RegisterAPIRoutes registers all application module routes with the provided
// API server.
func (app *Epix) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *Epix) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.BaseApp.GRPCQueryRouter(), clientCtx, app.BaseApp.Simulate, app.interfaceRegistry)
}

func (app *Epix) RegisterTendermintService(clientCtx client.Context) {
...
func (app *Epix) RegisterNodeService(clientCtx client.Context, cfg config.Config) {
...
func (app *Epix) GetBaseApp() *baseapp.BaseApp {
	return app.BaseApp
}

// GetStakingKeeper implements the TestingApp interface.
func (app *Epix) GetStakingKeeper() ibctestingtypes.StakingKeeper {
	return app.StakingKeeper
}

// GetIBCKeeper implements the TestingApp interface.
func (app *Epix) GetIBCKeeper() *ibckeeper.Keeper {
	return app.IBCKeeper
}

func (app *Epix) GetErc20Keeper() erc20keeper.Keeper {
	return app.Erc20Keeper
}

func (app *Epix) GetCoinswapKeeper() coinswapkeeper.Keeper {
	return app.CoinswapKeeper
}

func (app *Epix) GetOnboardingKeeper() *onboardingkeeper.Keeper {
	return app.OnboardingKeeper
}

// GetScopedIBCKeeper implements the TestingApp interface.
func (app *Epix) GetScopedIBCKeeper() capabilitykeeper.ScopedKeeper {
	return app.ScopedIBCKeeper
}

// GetTxConfig implements the TestingApp interface.
func (app *Epix) GetTxConfig() client.TxConfig {
	return app.txConfig
}

func (app *Epix) FinalizeBlock(req *abci.RequestFinalizeBlock) (*abci.ResponseFinalizeBlock, error) {
...
func (app *Epix) BlockedAddrs() map[string]bool {
